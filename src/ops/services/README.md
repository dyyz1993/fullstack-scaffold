...
### 1. RequestInterceptor (`src/ops/services/requestInterceptor.ts`)
...
### 2. CaptchaStore (`src/ops/stores/captchaStore.ts`)
...
### 3. CaptchaModal (`src/ops/components/CaptchaModal.tsx`)
...
### 4. ApiClient (`src/ops/services/apiClient.ts`)
...
```typescript
import { apiClient } from '@/ops/services/apiClient'
